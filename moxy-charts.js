...
var MoxyUI = /** @class */ (function () {
    function MoxyUI(data, title, opts) {
        ...
        this._opts = MoxyUIDefaultOptions;
        this._title = '';
        this._data = data;
        if (title) {
            this._title = title;
    ...
    MoxyUI.loadingBar = function (element, opts) {
        return __awaiter(this, void 0, void 0, function () {
            function step() {
                if (progress < 95) {
                    ...
                    var remainder = Math.floor((100 - progress) / 4);
            ...
            var bar, track, FPS, ETA, isDone, progress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        track.style.setProperty('background-color', opts.color ? 'var(--' + opts.color + ')' : 'var(--green)');
                        track.className = 'track';
                        bar.append(track);
                        element.prepend(bar);
                        FPS = 60;
                        ETA = (opts.maxTime / 1000) * FPS;
                        isDone = false;
                        progress = 0;
                        window.requestAnimationFrame(step);
                        return [4 /*yield*/, opts.fn()];
                    case 1:
                        _a.sent();
                        isDone = true;
                        progress = 100;
